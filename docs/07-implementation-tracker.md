...
The latest increment adds a real authenticated mixed-HTTP correctness harness
and fixes normal ingestion of the four liquidity metrics already required by
approval risk checks. See [mixed-workload verification](mixed-workload-verification.md).
