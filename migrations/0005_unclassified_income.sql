...
INSERT INTO postings_v5(id,event_id,account_id,currency,ledger_account,amount)
  SELECT id,event_id,account_id,currency,ledger_account,amount FROM postings;

DROP TABLE postings;
ALTER TABLE postings_v5 RENAME TO postings;
