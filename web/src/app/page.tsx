      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            {lastReport && (
              <Link href={`/reports/${lastReport.id}`} className="inline-flex items-center gap-1 text-blue-600 hover:underline dark:text-blue-400">
