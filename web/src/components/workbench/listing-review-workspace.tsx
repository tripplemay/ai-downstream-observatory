...
const panel = "min-w-0 space-y-3 rounded-xl border bg-card p-4 [overflow-wrap:anywhere]", field = "min-w-0 max-w-full w-full rounded border bg-background px-3 py-2 text-sm", button = "max-w-full whitespace-normal rounded border px-3 py-2 text-sm [overflow-wrap:anywhere] disabled:opacity-40";
